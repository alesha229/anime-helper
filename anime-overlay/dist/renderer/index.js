...
(() => {
  ...
  async function loadModel(app2, url, forceV4) {
    ...
    try {
      enableDraggingForModel(app2, getModel());
    } catch {
    }
  ...
  function enableDraggingForModel(app2, target, saveModelState3) {
    if (!target) return;
